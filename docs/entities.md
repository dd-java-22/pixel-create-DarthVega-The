...
- **Database Schema**: See [SQL DDL](data-model/ddl.md) for complete table definitions
...
- [Entity-Relationship Diagram](data-model/erd.md) - Visual representation of entity relationships
- [UML Class Diagram](data-model/index.md) - Detailed class structure with methods and properties
- [SQL DDL](data-model/ddl.md) - Database schema definition language
